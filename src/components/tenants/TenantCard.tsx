...
export function TenantCard({ tenant }: { tenant: Tenant }) {
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col gap-4 rounded-xl border border-line bg-card p-5 transition-all hover:border-line-soft hover:bg-card/60 hover:shadow-glow"
    >
