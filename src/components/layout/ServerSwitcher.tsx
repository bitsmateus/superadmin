  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        onClick={() => setOpen((s) => !s)}
        className={cn(
          'flex w-full items-center justify-between gap-2 rounded-lg border border-line bg-elevate/[0.03] px-3 py-2 text-left',
          'text-sm text-foreground/85 transition-colors hover:bg-elevate/[0.06] focus-ring',
        )}
      >
        ...
        <ChevronDown
          className={cn(
            'h-3.5 w-3.5 shrink-0 text-foreground/40 transition-transform',
            open && 'rotate-180',
          )}
        />
      </button>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isActive
                        ...
                        : 'text-foreground/70 hover:bg-elevate/[0.04] hover:text-foreground',
                    )}
                  >
